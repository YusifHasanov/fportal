                    ...
                    <div class="relative overflow-hidden">
                        ...
                        <div
                            ...
                            <div class="text-center py-8">
                                ...
                                <div
                                    class="inline-flex items-center bg-gradient-to-r from-green-600/20 to-green-500/20 text-green-400 px-4 py-2 rounded-full text-sm font-medium border border-green-500/30">
                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-orange-400 text-sm">Liqa cədvəlləri</p>
                                </div>
                            </div>

                            <div class="text-center py-8">
                                <div
                                    class="w-16 h-16 bg-orange-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <div
                                    class="inline-flex items-center bg-gradient-to-r from-orange-600/20 to-yellow-500/20 text-orange-400 px-4 py-2 rounded-full text-sm font-medium border border-orange-500/30">
                                    <div class="w-2 h-2 bg-orange-400 rounded-full animate-pulse mr-2"></div>
                                    Tezliklə
                                </div>
                            </div>
                        </div>
